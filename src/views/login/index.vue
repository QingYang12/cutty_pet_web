<template>
  <div class="login-container" style='background-image:url("/img/login.jpeg");background-size:100% 100%;'>
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">

      <div class="title-container">
        <h3 class="title">cutty_pet 登录</h3>
      </div>
    ...
    <el-dialog title="注册状态" :visible.sync="showDialog">
